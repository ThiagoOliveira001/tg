...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\trabalho-graduacao\pwa\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\trabalho-graduacao\pwa\src\pages\list\list.html"*/
        }),
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, _authService, toastCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    LoginPage.prototype.logar = function () {
        var _this = this;
        this._authService.logar(this.loginData).then(function (data) {
            _this._authService.setUser(data.usuario);
            _this._authService.setToken(data.token);
            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */]);
        }).catch(function (res) {
            console.log('catch');
            _this.presentToast(res.error.message);
        });
    };
    //banana
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\trabalho-graduacao\pwa\src\pages\login\login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title text-center>Login</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <ion-list>\n      <ion-item>\n        <ion-label>Usuario</ion-label>\n        <ion-input type="email" [(ngModel)]="loginData.email"></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Senha</ion-label>\n        <ion-input type="password" [(ngModel)]="loginData.senha"></ion-input>\n      </ion-item>\n    </ion-list>\n    <div>\n      <button ion-button (click)="logar()" (press)="logar()" block>ENTRAR</button>\n    </div>\n</ion-content>\n'/*ion-inline-end:"C:\trabalho-graduacao\pwa\src\pages\login\login.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environment_environment__ = __webpack_require__(281);
...
var AuthServiceProvider = /** @class */ (function () {
    ...
    AuthServiceProvider.prototype.authenticate = function () {
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_common_http__ = __webpack_require__(275);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
